 ...
 */
public class CreditBusinessException extends Exception {
    private static final long serialVersionUID = -599897360294509848L;

    public static final Integer CODE_DEFAULT = ResultCode.EXCEPTION_BUSINESS.getKey();
    public static final String MSG_DEFAULT = ResultCode.EXCEPTION_BUSINESS.getValue();
    ...
    public CreditBusinessException(Integer code, String msg) {
        super(msg);
        this.code = code;
        this.msg = msg;
    }
    ...
    public CreditBusinessException(String msg) {
