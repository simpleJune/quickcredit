...
import com.free.platform.base.utils.NumberUtils;
import com.free.platform.base.utils.RefectUtils;
import com.free.platform.base.utils.RefectUtils.FieldDecorator;
...
public class WebUtil {
	...
	public static String getUserToken(String token){
		...
		return token.substring(token.lastIndexOf(Constants.API_PARAMS_TOKEN_SPLIT)+1);
	}
	...
	public static String getUserId(String token){
		...
		return token.substring(0,token.indexOf(Constants.API_PARAMS_TOKEN_SPLIT));
	}
	...
	public static String getSystemType(String token) {
	    ...
	    return token.substring(token.indexOf(Constants.API_PARAMS_TOKEN_SPLIT)+1, token.lastIndexOf(Constants.API_PARAMS_TOKEN_SPLIT));
	}
	...
	/**
	 * 
	 * 方法描述：生成app端accessToken(userNumber + "_" + systemType + "_" + userToken)
	 * @param userNumber   用户ID
	 * @param systemType   系统编码
	 * @param userToken    随机token
	 * @return
	 */
	public static String getSysToken(String userNumber, String systemType, String userToken){
		String token = userNumber + Constants.API_PARAMS_TOKEN_SPLIT + systemType + Constants.API_PARAMS_TOKEN_SPLIT  + userToken;
		return token;
	}
	...
	/**
	 * http://www.free.com/relativePath
	 * 获取根目录模板
	 * @param request
	 * @param relativePath
	 * @return
