...
import com.free.platform.paginator.domain.PageBounds;
...
import com.free.platform.paginator.support.SQLHelp;
...
import com.free.platform.paginator.dialect.Dialect;
import com.free.platform.paginator.support.PropertiesHelper;
...
public class PageInterceptor implements Interceptor{
    ...
    public Object intercept(final Invocation invocation) throws Throwable {
        ...
        return new PageList(listFuture.get(),new Paginator(pageBounds.getPage(), pageBounds.getLimit(),0));
	}
